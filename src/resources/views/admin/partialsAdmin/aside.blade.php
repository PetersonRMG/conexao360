...
<aside class="app-sidebar shadow-lg"
  ...
  <div class="sidebar-brand"
    ...
    <a href="#" class="brand-link d-flex flex-column align-items-center text-decoration-none gap-3">
  ...
  <div class="sidebar-wrapper" style="padding: 0.75rem;">
    ...
    <li class="nav-item">
  <a href="{{ route('admin.content') }}" class="nav-link d-flex align-items-center rounded-3 px-3 py-2 text-white {{ Request::routeIs('admin.content') ? 'active' : '' }} sidebar-custom-hover">
...
<li class="nav-item">
  <a href="{{ route('admin.depoimentos.index') }}" class="nav-link d-flex align-items-center rounded-3 px-3 py-2 text-white sidebar-custom-hover">
...
<li class="nav-item {{ Request::is('admin/cadastro*') ? 'menu-open' : '' }}">
  <a href="#" class="nav-link d-flex align-items-center justify-content-between rounded-3 px-3 py-2 text-white-50 sidebar-custom-hover">
  ...
  <ul class="nav nav-treeview flex-column gap-1 mt-1 ps-2">
    {{-- Opção: Usuários --}}
    <li class="nav-item">
      <a href="{{ route('admin.cadastro.usuarios') }}" class="nav-link d-flex align-items-center rounded-3 px-3 py-2 sidebar-subitem-custom {{ Request::routeIs('admin.cadastro.usuarios') ? 'active' : '' }}">
    ...
    {{-- Opção: Palestrantes --}}
    <li class="nav-item">
      <a href="{{ route('admin.cadastro.palestrantes') }}" class="nav-link d-flex align-items-center rounded-3 px-3 py-2 sidebar-subitem-custom {{ Request::routeIs('admin.cadastro.palestrantes') ? 'active' : '' }}">
