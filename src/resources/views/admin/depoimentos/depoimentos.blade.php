    ...
    <div class="dep-panel">
        ...
        <div class="dep-tabs-wrapper">
            ...
            <div class="dep-tabs" id="customDepTabs">
                ...
                <button
                    type="button"
                    class="dep-tab active"
                    data-target="#pendentes"
                >
                    ...
                    <article class="dep-card">
                        ...
                        <div class="dep-card-header">
                            ...
                            <div class="dep-author">
                                ...
                                <img
                                    ...
                                    class="dep-avatar"
                                    alt="Avatar de {{ $item->usuario->nome_usuario }}"
                                >
                        ...
                        <div class="dep-card-footer">
                            ...
                            <div class="dep-actions">
                                ...
                                <form
                                    action="{{ route('admin.depoimentos.recusar', $item->id_depoimentos) }}"
                                    method="POST"
                                >
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <button
                                        type="submit"
                                        class="dep-action dep-action--reject"
                                    >
                                ...
                                <form
                                    action="{{ route('admin.depoimentos.aceitar', $item->id_depoimentos) }}"
                                    method="POST"
                                >
                                    @csrf
                                    @method('PUT')
                                    ...
                                    <button
                                        type="submit"
                                        class="dep-action dep-action--approve"
                                    >
