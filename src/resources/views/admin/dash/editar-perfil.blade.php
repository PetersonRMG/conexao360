                        ...
                        <div  class="row g-3 col-md-12 ">
                            ...
                            <div class="col-md-12 row bg-">
                                <div class="rounded col-md-6">
                                    <img class="rounded" src="{{asset('dash/assets/img/'. $perfil->foto_usuario) }}">
                            ...
                            <label class="form-label" for="status_usuario"> Status </label>
                                <select class="form-select" id="status_usuario" name="status_usuario">
                                    <option value="Ativo"
                                        {{ $perfil->status_usuario == 'Ativo' ? 'selected' : '' }}>Ativo</option>
                                    <option
                                        value="Inativo"{{ $perfil->status_usuario ==  'INATIVO' ? 'selected' : '' }}>
                                        Inativo
                                    </option>
                                </select>
                            </div>
