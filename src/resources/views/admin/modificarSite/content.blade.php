...
@section('content')
    <main class="app-main dash-main--bg site-editor-main"
        ...
        <div class="app-content container-fluid site-editor-page">
                ...
                <div class="site-editor-tabs">
                    ...
                    <div class="site-editor-tabs-header">
                        ...
                        <div class="site-editor-tabs-title">
                            ...
                            <button type="button" class="btn-site-preview" data-bs-toggle="modal"
                                data-bs-target="#sitePreviewModal">
                        ...
                        <ul class="nav nav-tabs site-editor-nav" id="siteEditorTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="eventos-tab" data-bs-toggle="tab"
                                    data-bs-target="#eventos-pane" type="button" role="tab" aria-controls="eventos-pane"
                                    aria-selected="false">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="temas-tab" data-bs-toggle="tab" data-bs-target="#temas-pane"
                                    type="button" role="tab" aria-controls="temas-pane" aria-selected="false">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="videos-tab" data-bs-toggle="tab" data-bs-target="#videos-pane"
                                    type="button" role="tab" aria-controls="videos-pane" aria-selected="false">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="dra-tab" data-bs-toggle="tab" data-bs-target="#dra-pane"
                                    type="button" role="tab" aria-controls="dra-pane" aria-selected="false">
                    ...
                    <div class="tab-content site-editor-tab-content" id="siteEditorTabContent">
                        ...
                        <div class="tab-pane fade show active" id="banner-pane" role="tabpanel" aria-labelledby="banner-tab"
                            ...
                            <div class="site-editor-section-header">
                                ...
                                <button type="button" class="btn-site-editor-add" data-bs-toggle="modal"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12 col-md-6 mb-3">
                                                                    ...
                                                                    <select class="form-select" name="status_hero">
                                                                        <option value="ATIVO" {{ $item->status_hero == 'ATIVO' ? 'selected' : '' }}>
                                                                            Ativo
                                                                        </option>

                                                                        <option value="INATIVO" {{ $item->status_hero == 'INATIVO' ? 'selected' : '' }}>
                                                                            Inativo
                                                                        </option>
                                                                    </select>
                                                                </div>
                                                        ...
                                                        <div class="col-12 col-lg-4">
                                                            ...
                                                            <div class="media-preview-container mb-3">
                                                                <img src="{{ asset('conexao360/img/' . $item->foto_banner) }}"
                                                                    class="img-fluid" alt="Banner atual">
                                                            </div>
                        ...
                        EVENTOS
                        ======================================================= --}}
                        <div class="tab-pane fade" id="eventos-pane" role="tabpanel" aria-labelledby="eventos-tab"
                            tabindex="0">
                                            ...
                                            <form method="POST" action="{{ route('admin.evento.update', $item->id_evento) }}"
                                                ...
                                                <div class="site-editor-card h-100">
                                                    ...
                                                    <div class="premium-item-card">
                                                        ...
                                                        <div class="media-preview-container mb-3">
                                                            <iframe src="{{ $item->url_evento }}" width="600" height="50"
                                                    ...
                                                    <div class="site-editor-card-footer">
                                                        ...
                                                        <button type="submit" class="btn-site-editor-save w-100">
                                                            <i class="bi bi-check-circle"></i>
                                                            Salvar Evento
                                                        </button>
                        ...
                        TEMAS
                        ======================================================= --}}
                        <div class="tab-pane fade" id="temas-pane" role="tabpanel" aria-labelledby="temas-tab" tabindex="0">
                                ...
                                @foreach ($video as $item)
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <form method="POST" action="{{ route('admin.video.update', $item->id_video) }}"
                                                enctype="multipart/form-data">
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-12 col-lg-8">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="titulo_video"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" name="subtitulo_video"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" name="breve_descricao_video"
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <input type="text" class="form-control" name="legenda_video"
                                                                ...
                                                                <div class="col-md-6 mb-3">
                                                                    ...
                                                                    <select class="form-select" name="status_video">
                                                        ...
                                                        <div class="col-12 col-lg-4">
                                                            ...
                                                            <div class="media-preview-container mb-3">
                                                                <img src="{{ asset('conexao360/img/' . $item->capa_video) }}"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" class="form-control" name="capa_video"
                                                                    accept="image/png,image/jpeg,image/webp">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="file" class="form-control" name="url_video"
                        ...
                        DRA
                        ======================================================= --}}
                        <div class="tab-pane fade" id="dra-pane" role="tabpanel" aria-labelledby="dra-tab" tabindex="0">
                                ...
                                @foreach ($dra as $item)
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <form method="POST" action="{{ route('admin.dra.update', $item->id_dra) }}"
                                                enctype="multipart/form-data">
                                                    ...
                                                    <div class="row g-4">
                                                        ...
                                                        <div class="col-12 col-lg-8">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="titulo_dra"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" class="form-control" name="sub_titulo_dra"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <textarea class="form-control" name="descricao_dra"
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <select class="form-select" name="status_dra">
    ...
    {{-- ==========================================================
    PRÉVIA DO SITE PUBLICADO
    ------------------------------------------------------------------
    A prévia utiliza a rota pública real, portanto representa com
    fidelidade a versão atualmente SALVA no banco.
    =========================================================== --}}
    <div class="modal fade site-preview-modal" id="sitePreviewModal" tabindex="-1" aria-labelledby="sitePreviewModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered site-preview-dialog">

            <div class="modal-content site-preview-content">

                <div class="site-preview-toolbar">

                    <div class="site-preview-heading">
                        <span class="site-preview-icon">
                            <i class="bi bi-display"></i>
                        </span>

                        <div>
                            <h5 id="sitePreviewModalLabel">
                                Prévia do Site
                            </h5>

                            <p>
                                Exibe a versão atualmente salva da Landing Page.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="site-preview-actions">
                        ...
                        <div class="site-preview-devices" role="group" aria-label="Tamanho da prévia">
                            <button type="button" class="site-preview-device active" data-preview-device="desktop"
                                title="Desktop">
                                <i class="bi bi-display"></i>
                            </button>

                            <button type="button" class="site-preview-device" data-preview-device="tablet" title="Tablet">
                                <i class="bi bi-tablet"></i>
                            </button>

                            <button type="button" class="site-preview-device" data-preview-device="mobile" title="Mobile">
                                <i class="bi bi-phone"></i>
                            </button>
                        </div>


                        <button type="button" class="site-preview-refresh" id="refreshSitePreview" title="Atualizar prévia">
                            <i class="bi bi-arrow-clockwise"></i>
                        </button>


                        <button type="button" class="site-preview-close" data-bs-dismiss="modal" aria-label="Fechar">
                ...
                <div class="site-preview-stage is-desktop" id="sitePreviewStage">
                    <div class="site-preview-frame-shell">

                        <iframe id="sitePreviewFrame" src="{{ route('home') }}" title="Prévia do site Advocacia Exponencial"
                            loading="lazy"></iframe>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const previewModal = document.getElementById('sitePreviewModal');
            const previewFrame = document.getElementById('sitePreviewFrame');
            const previewStage = document.getElementById('sitePreviewStage');
            const refreshButton = document.getElementById('refreshSitePreview');
            const deviceButtons = document.querySelectorAll('.site-preview-device');

            if (!previewModal || !previewFrame || !previewStage) {
                return;
            }

            function reloadPreview() {
                const currentSrc = previewFrame.getAttribute('src');
                previewFrame.setAttribute('src', currentSrc);
            }
            ...
            deviceButtons.forEach(function (button) {
                ...
                button.addEventListener('click', function () {
                    ...
                    const device = this.dataset.previewDevice;
                    ...
                    previewStage.classList.add('is-' + device);
                });

            });

            if (refreshButton) {
                refreshButton.addEventListener('click', reloadPreview);
            }
    ...
    @if (session('success'))
        <div class="toast-container dash-toast-container position-fixed bottom-0 end-0 p-3">
            <div id="liveToast" class="toast show site-editor-toast" role="alert" aria-live="assertive" aria-atomic="true">
                <div class="toast-header site-editor-toast-header">
                    <i class="bi bi-bookmark-star-fill me-2"></i>
                    <strong class="me-auto">Alterado com Sucesso</strong>
                    <button type="button" class="btn-close site-editor-toast-close" data-bs-dismiss="toast"
                        aria-label="Close"></button>
                </div>
                <div class="toast-body site-editor-toast-body">
                    {{ session('success') }}
                </div>
            </div>
        </div>
