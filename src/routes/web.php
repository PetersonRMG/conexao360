...
Route::prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware(['auth:admin','admin'])->group(function(){
        ...
        Route::put('/banner/update{id}', [HeroController::class, 'updateHero'])->name('hero.update');
            ...
            // Route::put('/depoimentos', [DepoimentosController::class, 'createDepoimento'])->name('depoimento.create');
     ...
     Route::prefix('palestrante')
    ->name('palestrante.')
    ->middleware(['auth:admin','palestrante'])
         ->group(function () {

        // Route::get('/', [PalestranteController::class,'dashboard'])
        //     ->name('dash');

        // Route::get('/perfil', [PalestranteController::class,'perfil'])
        //     ->name('perfil');

        // Route::get('/depoimentos', [DepoimentosController::class,'index'])
        //     ->name('depoimentos');

        // Route::put('/depoimento/create',
        //     [DepoimentosController::class,'createDepoimento'])
        //     ->name('depoimento.create');
